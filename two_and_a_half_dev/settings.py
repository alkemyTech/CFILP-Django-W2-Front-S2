"""
Django settings for two_and_a_half_dev project.
...
SECRET_KEY = 'django-insecure-^*-rg$umqxr^nkb-x-1^z0&m)b4lf)xq+!4pup43i#*n@)qju#'
...
ROOT_URLCONF = 'two_and_a_half_dev.urls'
...
# Importante agregarlo para que funcione
REST_FRAMEWORK = {
